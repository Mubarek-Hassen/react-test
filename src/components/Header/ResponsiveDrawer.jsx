...
function ResponsiveDrawer(props) {
  ...
  const drawer = (
    <div>
      <Toolbar />
      {/* <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS2W9COm2KpsSYsXUwJOcqxUzxth1ssNNFzrg&usqp=CAU" alt="cat" style={{borderRadius: '50%', border: 'black 2px solid'}} />
      <h3>Janet Perkins</h3>
      <p>Charleston, SC</p>
      <Divider /> */}
      <List>
